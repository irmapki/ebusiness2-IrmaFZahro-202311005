<x-admin-layout>
    ...
    <div class="mb-6">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
            ...
            <p class="text-gray-600 mt-1">Add a new user or administrator to the system</p>
        </div>
    </div>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <label class="relative flex cursor-pointer">
                        <input type="radio" name="role" value="user" {{ old('role', 'user') == 'user' ? 'checked' : '' }} class="sr-only peer" required>
                    ...
                    <label class="relative flex cursor-pointer">
                        ...
                        <div class="w-full p-5 bg-white border-2 border-gray-200 rounded-xl peer-checked:border-purple-500 peer-checked:bg-purple-50 transition-all hover:border-gray-300">
                            <div class="flex items-center justify-between mb-2">
                                ...
                                <div class="w-5 h-5 border-2 border-gray-300 rounded-full peer-checked:border-purple-500 peer-checked:bg-purple-500"></div>
                            </div>
                        </div>
                    </label>
                </div>
