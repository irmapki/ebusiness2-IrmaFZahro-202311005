<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center gap-4">
            <a href="{{ route('shop.index') }}" class="text-gray-600 hover:text-gray-800">
                    ...
                    <div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="flex items-center gap-3">
                                <button class="bg-gray-200 hover:bg-gray-300 text-gray-800 w-10 h-10 rounded-lg font-bold transition duration-200">
                                    -
                                </button>
                        ...
                        <div class="flex gap-3">
                            @if($product->stock > 0)
                                <button class="flex-1 bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-lg font-bold text-lg transition duration-200 flex items-center justify-center gap-2">
                                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button class="bg-pink-500 hover:bg-pink-600 text-white px-6 py-3 rounded-lg font-bold transition duration-200">
                                <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
