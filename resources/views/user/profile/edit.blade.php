<x-user-layout>
    <div class="max-w-4xl">
        <h2 class="text-3xl font-bold text-gray-800 mb-8">⚙️ Profile Settings</h2>
        ...
        <div class="bg-white rounded-2xl shadow-sm p-8 mb-6">
            ...
            <form method="POST" action="{{ route('user.profile.update') }}">
                ...
                <button type="submit" class="px-6 py-3 bg-purple-600 text-white font-bold rounded-lg hover:bg-purple-700 transition">
                    Save Changes
                </button>
            </form>
        </div>
    ...
    <div class="max-w-4xl">
        ...
        <div class="bg-white rounded-2xl shadow-sm p-8 border-l-4 border-red-500">
            ...
            <form method="POST" action="{{ route('user.profile.destroy') }}" onsubmit="return confirm('Are you sure? This action cannot be undone!');">
                @csrf
                @method('DELETE')
