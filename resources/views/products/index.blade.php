<x-app-layout>
    ...
    <div class="py-8">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            @if (session('success'))
                <div class="mb-6 bg-gradient-to-r from-green-50 to-emerald-50 border-l-4 border-green-500 text-green-700 px-6 py-4 rounded-lg shadow-md animate-fade-in" role="alert">
            ...
            <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
                <!-- Stats Cards -->
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 p-6 bg-gradient-to-br from-gray-50 to-white">
                    ...
                    <div class="bg-white p-4 rounded-xl shadow-md border border-gray-100">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <p class="text-sm text-gray-600 font-medium">Produk Aktif</p>
                    ...
                    <div class="bg-white p-4 rounded-xl shadow-md border border-gray-100">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-gray-800">Rp {{ number_format($products->sum(fn($p) => $p->price * $p->stock), 0, ',', '.') }}</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6">
                    @forelse ($products as $product)
                        <div class="bg-white border border-gray-200 rounded-xl p-5 mb-4 hover:shadow-lg hover:border-indigo-200 transition-all duration-300 transform hover:-translate-y-1">
                            <div class="flex items-center justify-between">
                                <div class="flex items-center space-x-5 flex-1">
                                    ...
                                    <div class="flex-shrink-0">
                                        @if($product->image)
                                            <img src="{{ asset('storage/' . $product->image) }}" 
                                                 alt="{{ $product->name }}" 
                                                 class="h-24 w-24 object-cover rounded-xl shadow-md ring-2 ring-gray-100">
                                        @else
                                            <div class="h-24 w-24 bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl flex items-center justify-center shadow-md">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="text-sm text-gray-600 mb-2 line-clamp-1">{{ $product->description ?: 'Tidak ada deskripsi' }}</p>
                    ...
                    @empty
                        <div class="text-center py-16">
                            ...
                            <a href="{{ route('admin.products.create') }}" 
                               class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-200">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                                </svg>
